...
class ExploreFortalezaView: UIView {
...
@available(iOS 13, *)
struct ExploreNFortalezaView_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            ExploreFortalezaView().showPreview().previewLayout(.fixed(width: 375.0, height: 219.0))
