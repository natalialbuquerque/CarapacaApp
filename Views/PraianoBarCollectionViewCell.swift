//
//  PraianoBarCollectionViewCell.swift
//  CarapacaApp
//
...
class PraianoBarCollectionViewCell: UICollectionViewCell {
    static let identifier = "praianoBarCell"
    ...
    func setup(with local: PraianoModel) {
...
@available(iOS 13, *)
struct PraianoBarCollectionViewCell_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            PraianoBarCollectionViewCell().showPreview().previewLayout(.fixed(width: 157.0, height: 136.0))
