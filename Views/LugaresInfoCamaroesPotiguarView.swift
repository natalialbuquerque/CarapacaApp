//
//  LugaresInfoCamaroesPotiguarView.swift
//  CarapacaApp
//
...
class LugaresInfoCamaroesPotiguarView: UIView {
        // MARK: - Inicializar os componentes/ as views
        let bgImageView = UIImageView(image: UIImage(named:"Camarões Potiguar 4"))
        ...
        let fotosCollectionView: UICollectionView = {
            ...
            collectionView.register(CamaroesPotiguarCollectionViewCell.self, forCellWithReuseIdentifier: CamaroesPotiguarCollectionViewCell.identifier)
    ...
    //    weak var delegate: HomeViewDelegate?
        ...
        required init?(coder: NSCoder) {
            ...
            func setUpAttributes(){
                ...
                title1Label.text = "Camarões Potiguar"
                ...
                enderecoDetalhesLabel.text = " R. Pedro Fonseca Filho, 8887 - Ponta Negra, Natal - RN, 59090-080"
                ...
                telefoneDetalhesLabel.text = "(84) 3209-2425"
    ...
    @available(iOS 13, *)
    struct LugaresInfoCamaroesPotiguarView_Preview: PreviewProvider {
        static var previews: some View {
            // view controller using programmatic UI
            Group {
                LugaresInfoCamaroesPotiguarView().showPreview().previewDevice("iPhone 11").previewInterfaceOrientation(.portrait)
