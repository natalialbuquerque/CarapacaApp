//
//  DragaoCollectionViewCell.swift
//  CarapacaApp
//
...
class DragaoCollectionViewCell: UICollectionViewCell {
    static let identifier = "dragaoCell"
    ...
    func setup2(with local: DragaoModel) {
...
@available(iOS 13, *)
struct DragaoCollectionViewCell_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            DragaoCollectionViewCell().showPreview().previewLayout(.fixed(width: 157.0, height: 136.0))
