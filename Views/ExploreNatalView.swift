...
@available(iOS 13, *)
struct ExploreNatalView_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            ExploreNatalView().showPreview().previewLayout(.fixed(width: 375.0, height: 219.0))
