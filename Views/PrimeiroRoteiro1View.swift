...
class PrimeiroRoteiro1View: UIView {
    ...
    var destinoTableView: UITableView = {
        ...
        table.register(PrimeiroRoteiro1TableViewCell.self, forCellReuseIdentifier: PrimeiroRoteiro1TableViewCell.identifier)
...
@available(iOS 13, *)
struct PrimeiroRoteiro1View_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            PrimeiroRoteiro1View().showPreview().previewDevice("iPhone 11").previewInterfaceOrientation(.portrait)
