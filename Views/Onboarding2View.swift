...
class Onboarding2View: UIView {
    ...
    func setupConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            linha.widthAnchor.constraint(equalToConstant: 116),
...
@available(iOS 13, *)
struct Onboarding2View_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            Onboarding2View().showPreview().previewDevice("iPhone SE (2nd generation)").previewInterfaceOrientation(.portrait)
