...
class PessoasCollectionViewCell: UICollectionViewCell {
    ...
    static let identifier = "pessoasCell"
...
@available(iOS 13, *)
struct PessoasCollectionViewCell_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        Group {
            
            PessoasCollectionViewCell().showPreview().previewLayout(.fixed(width: 157.0, height: 136.0))
