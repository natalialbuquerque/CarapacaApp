...
class RendaCollectionViewCell: UICollectionViewCell {

    static let identifier = "rendaCell"
...
struct RendaCollectionViewCell_Preview: PreviewProvider {
    static var previews: some View {
        ...
        Group {
            RendaCollectionViewCell().showPreview().previewLayout(.fixed(width: 157.0, height: 136.0))
